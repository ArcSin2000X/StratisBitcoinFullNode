    ...
    public class CirrusMain : PoANetwork
    {
        ...
        internal CirrusMain()
        {
            ...
            var genesisFederationMembers = new List<IFederationMember>()
			{
                ...
                new CollateralFederationMember(new Mnemonic("slam snap produce much figure liberty mandate habit devote chapter shop wrong").DeriveExtKey().PrivateKey.PubKey, new Money(500_00000000), "Sbt7zTrPBVRSFcYPzg2AkF6fUBxwT8VSYL"),
                new CollateralFederationMember(new Mnemonic("bonus muffin foam window junk help grain leg radio balance december virus").DeriveExtKey().PrivateKey.PubKey, new Money(500_00000000), "Sa4ppYDD4VyubqQHAapGdhp8RywPnZKFeg"),
                new CollateralFederationMember(new Mnemonic("crop pledge chair ecology example face stone album unusual eyebrow injury again").DeriveExtKey().PrivateKey.PubKey, new Money(500_00000000), "SjLTWcADStEeeRk1SEikZam92nqb2K2fE6"),
                new CollateralFederationMember(new Mnemonic("vital miracle claw jazz actress bean cabbage wrist urge company roof salmon").DeriveExtKey().PrivateKey.PubKey, new Money(500_00000000), "SahQUQhhWg1HyYVgSv44PVMMR64QyDSh2d"),
                new CollateralFederationMember(new Mnemonic("diet trust unaware road welcome proud shoot price laugh large awkward pipe").DeriveExtKey().PrivateKey.PubKey, new Money(500_00000000), "SUDC7FivxxDSxqEKk3nxq5LzQUj3oWFWKW"),
                new CollateralFederationMember(new Mnemonic("solution inspire flight water horn employ notable disease staff brisk script meadow").DeriveExtKey().PrivateKey.PubKey, new Money(500_00000000), "ScMVyftzrURw1z4t98W71tPxUk1ehsgUjE"),
                new CollateralFederationMember(new Mnemonic("they sun romance wheat army pulp year zoo fly soda sail true").DeriveExtKey().PrivateKey.PubKey, new Money(500_00000000), "Sbvr8Umnc2BrD6DaGVkD2cbYYxU8Hyftc4"),
                new CollateralFederationMember(new Mnemonic("edge habit misery swarm tape viable toddler young shoe immense usual faculty").DeriveExtKey().PrivateKey.PubKey, new Money(500_00000000), "SbQwJ3SjsQUi3rYHMHhr7oYXJr85KaheR6")
            ...
            this.DNSSeeds = new List<DNSSeedData>
			{
                ...
                new DNSSeedData("seeder.sidechain1.stratisplatform.com", "seeder.sidechain1.stratisplatform.com")
